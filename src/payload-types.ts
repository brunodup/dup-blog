...
export interface Post {
  id: number;
  type: 'text' | 'image' | 'quote' | 'video' | 'audio' | 'snippet';
  title?: string | null;
  body?: {
    root: {
      type: string;
  ...
  jsMode?: ('vanilla' | 'jsx' | 'threejs') | null;
  html?: string | null;
  css?: string | null;
  js?: string | null;
  ...
  position_x: number;
  /**
   * Posição vertical no mural (0–100%).
   */
  position_y: number;
  /**
...
export interface Page {
  ...
  /**
   * Gerado automaticamente a partir do título. URL: /{slug}
   */
  slug?: string | null;
  updatedAt: string;
  createdAt: string;
...
export interface Lead {
  ...
  email: string;
  /**
   * Slug da ferramenta onde o e-mail foi captado.
   */
  source?: string | null;
  updatedAt: string;
  createdAt: string;
